...
@interface RootViewController : UIViewController <AVAudioPlayerDelegate, UIApplicationDelegate,MFMailComposeViewControllerDelegate,AudioSettingsDelegate,UIWebViewDelegate,FBSessionDelegate,FBRequestDelegate,FBDialogDelegate>


{
    __weak IBOutlet UIButton *volumeBtn;
     MPMusicPlayerController *musicPlayer;
    UISlider *volumeControler;
    NSMutableArray *audioarray;
    int nextAudioVar;
    BOOL volumeEnable;
    NSString *BeadString,*MalaString;
    
}
- (IBAction)volumecontroller:(id)sender;
@property (unsafe_unretained, nonatomic) IBOutlet UIButton *PreviousBtn;
